	...
	<body class="w3-content w3-light-grey">
		...
		<form action="javascript:AddNewTextSection()" method="post">
			...
			<div class="w3-section w3-left-align w3-margin-left w3-margin-right" style="width: 100%">
				...
				<textarea class="w3-input w3-border w3-text" rows="8" style="width: 100%" id="Text" name="Text" required></textarea>
			</div>
